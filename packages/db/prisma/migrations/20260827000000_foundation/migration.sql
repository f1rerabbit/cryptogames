...
CREATE TABLE "AuditEvent" ("id" UUID PRIMARY KEY, "actorId" TEXT, "subjectId" TEXT, "action" TEXT NOT NULL, "outcome" TEXT NOT NULL, "reason" TEXT, "correlationId" TEXT NOT NULL, "metadata" JSONB NOT NULL, "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now());
...
CREATE TABLE "LedgerTransaction" ("id" UUID PRIMARY KEY, "assetCode" TEXT NOT NULL REFERENCES "Asset"("code"), "type" TEXT NOT NULL, "referenceId" TEXT, "compensatesId" TEXT, "correlationId" TEXT NOT NULL, "createdAt" TIMESTAMPTZ NOT NULL DEFAULT now());
